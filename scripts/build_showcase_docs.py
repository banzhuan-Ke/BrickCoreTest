...
SOURCES: list[tuple[str, str, str]] = [
    ...
    ("release-notes", "scripts/ce-stubs/docs-release-notes-ce.md", "版本更新记录"),
    ("project-setup", "docs-site/guide/project-setup.md", "项目与环境"),
    ("test-catalog", "docs-site/guide/test-catalog.md", "测试目录"),
    ("ui-automation", "scripts/ce-stubs/docs-ui-automation-ce.md", "Web 自动化"),
    ("app-automation", "scripts/ce-stubs/docs-app-automation-ce.md", "App 自动化"),
    ...
    ("browser-lab", "scripts/ce-stubs/docs-browser-lab-ce.md", "智能浏览器"),
    ...
    manifest = {
        ...
        "groups": [
            ...
            },
            {
                "id": "group-guide",
                "title": "功能模块",
                "children": [child(d, t) for d, _, t in SOURCES[6:18]],
            },
            {
                "id": "group-system",
                "title": "系统管理",
                "children": [child(d, t) for d, _, t in SOURCES[18:]],
            },
        ],
    }
