...
| 方式 | 说明 |
|------|------|
| **网盘下载（推荐）** | [百度网盘](https://pan.baidu.com/s/1Nx2fkPAUi7htJKZAxp1paw?pwd=ye6b)（提取码 `ye6b`）；或见 [README 执行器章节](../../README.md#执行器下载windows--约-800mb)；登录 [演示平台](http://43.142.83.156/) → **设备管理** → **网盘下载** |
