...
async def upgrade(db: BaseDBAsyncClient) -> str:
    return """
        CREATE TABLE IF NOT EXISTS `api_test_file` (
            ...
            CONSTRAINT `fk_api_test_file_project` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`) ON DELETE CASCADE,
            KEY `idx_api_test_file_project` (`project_id`),
            KEY `idx_api_test_file_key` (`file_key`(191))
        ) CHARACTER SET utf8mb4 COMMENT='接口自动化测试文件';
    """
