from app.modules.stream_phase.contract import (
    STREAM_BURST_MODE,
...
from app.modules.stream_phase.aggregate import aggregate_phase_metrics, detail_to_excel_row
from app.modules.stream_phase.registry import list_parsers, get_parser_preset, parse_stream_lines
from app.modules.stream_phase.engine import execute_stream_request, stream_result_to_perf_queue_item, extract_stream_detail, migrate_legacy_detail
