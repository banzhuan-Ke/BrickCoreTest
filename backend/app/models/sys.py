...
class NotificationConfig(models.Model):
    ...
    api_alert_on_failure = fields.BooleanField(default=True, description="API套件/计划执行失败时发送告警")
    ui_alert_on_failure = fields.BooleanField(default=True, description="Web计划/套件执行失败时发送告警")
    perf_alert_on_failure = fields.BooleanField(default=True, description="性能测试执行失败时发送告警")
    app_alert_on_failure = fields.BooleanField(default=True, description="App计划/套件执行失败时发送告警")
    ...
    # 兼容旧字段：创建/更新时同步为「套件 OR 计划」
    api_auto_push_report = fields.BooleanField(default=False, description="API自动推报告(兼容：套件或计划任一开启)")
    api_suite_auto_push_report = fields.BooleanField(default=False, description="API套件执行完成后自动推送报告（含定时；成功/失败均推）")
    api_plan_auto_push_report = fields.BooleanField(default=False, description="API计划执行完成后自动推送报告（含定时；成功/失败均推）")
    ui_auto_push_report = fields.BooleanField(default=False, description="Web自动推报告(兼容：套件或计划任一开启)")
    ui_suite_auto_push_report = fields.BooleanField(default=False, description="Web独立套件执行完成后自动推送报告（含定时）")
    ui_plan_auto_push_report = fields.BooleanField(default=False, description="Web计划执行完成后自动推送报告（含定时）")
    perf_auto_push_report = fields.BooleanField(default=False, description="性能测试执行完成后自动推送报告")
    app_auto_push_report = fields.BooleanField(default=False, description="App自动推报告(兼容：套件或计划任一开启)")
    app_suite_auto_push_report = fields.BooleanField(default=False, description="App独立套件执行完成后自动推送报告（含定时）")
    app_plan_auto_push_report = fields.BooleanField(default=False, description="App计划执行完成后自动推送报告（含定时）")
