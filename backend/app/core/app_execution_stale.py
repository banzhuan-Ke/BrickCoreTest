...
from app.core.app_device_lock import release_device_lock_by_udid, release_device_locks_for_holder
...
async def _release_stale_exec_lock(record: AppSuiteExecution | AppCaseExecution) -> None:
    if isinstance(record, AppSuiteExecution) and record.plan_execution_id:
        from app.core.app_runner_results import _reaggregate_app_plan_execution
