...
BUILTIN_DOC_ENTRIES: dict[str, tuple[str, str]] = {
    ...
    "api-mock": ("docs-site/guide/api-mock.md", "Mock 服务"),
    ...
    "test-management": ("docs-site/guide/test-management.md", "测试管理"),
    "brickcore-tm-pack": ("docs-site/guide/brickcore-tm-pack.md", "测试管理扩展包"),
...
BUILTIN_DOC_TREE: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "children": [
            ...
            {"id": "api-mock", "title": "Mock 服务", "type": "builtin"},
            ...
            {"id": "test-management", "title": "测试管理", "type": "builtin"},
            {"id": "brickcore-tm-pack", "title": "测试管理扩展包", "type": "builtin"},
