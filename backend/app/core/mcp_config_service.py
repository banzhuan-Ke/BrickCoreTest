...
from app.core.config import BASE_URL as ENV_BASE_URL
from app.core.config import MCP_API_KEY as ENV_MCP_API_KEY
from app.core.config import MCP_ENABLED as ENV_MCP_ENABLED
