...
_UI_VALID_METHODS = {
    "open_url", "refresh", "go_back", "scroll_to_height", "execute_script",
    ...
    "kw_assert_element_text", "kw_assert_attribute", "kw_assert_visible",
...
_UI_REQUIRED_PARAMS = {
    ...
    "kw_assert_value": {"locator"},
    "kw_assert_element_text": {"locator", "text"},
    "kw_assert_attribute": {"locator", "attr_name"},
